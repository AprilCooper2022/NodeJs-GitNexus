...
import { C as _objectSpread2$1, F as _callSuper$1, I as _classCallCheck$1, L as _createClass$1, N as floatColor, R as _inherits$1, T as createEdgeCompoundProgram, b as FRAGMENT_SHADER_SOURCE, g as DEFAULT_EDGE_ARROW_HEAD_PROGRAM_OPTIONS, v as EdgeProgram, w as createEdgeArrowHeadProgram } from "./data-11df7124.esm-DTEoN1FH.js";
import { t as require_is_graph } from "./is-graph-CCBvMEbT.js";
//#region node_modules/sigma/rendering/dist/sigma-rendering.esm.js
var _WebGLRenderingContex$3 = WebGLRenderingContext;
_WebGLRenderingContex$3.UNSIGNED_BYTE;
_WebGLRenderingContex$3.FLOAT;
...
var DEFAULT_EDGE_DOUBLE_CLAMPED_PROGRAM_OPTIONS = { lengthToThicknessRatio: DEFAULT_EDGE_ARROW_HEAD_PROGRAM_OPTIONS.lengthToThicknessRatio };
function createEdgeDoubleClampedProgram(inputOptions) {
	var options = _objectSpread2$1(_objectSpread2$1({}, DEFAULT_EDGE_DOUBLE_CLAMPED_PROGRAM_OPTIONS), inputOptions || {});
	return /*#__PURE__*/ function(_EdgeProgram) {
		function EdgeDoubleClampedProgram() {
			_classCallCheck$1(this, EdgeDoubleClampedProgram);
			return _callSuper$1(this, EdgeDoubleClampedProgram, arguments);
		}
		_inherits$1(EdgeDoubleClampedProgram, _EdgeProgram);
		return _createClass$1(EdgeDoubleClampedProgram, [
			{
				key: "getDefinition",
...
function createEdgeDoubleArrowProgram(inputOptions) {
	return createEdgeCompoundProgram([
		...
		createEdgeArrowHeadProgram(_objectSpread2$1(_objectSpread2$1({}, inputOptions), {}, { extremity: "source" }))
	]);
}
createEdgeDoubleArrowProgram();
var _WebGLRenderingContex$1 = WebGLRenderingContext;
_WebGLRenderingContex$1.UNSIGNED_BYTE;
_WebGLRenderingContex$1.FLOAT;
var _WebGLRenderingContex$4 = WebGLRenderingContext;
_WebGLRenderingContex$4.UNSIGNED_BYTE;
_WebGLRenderingContex$4.FLOAT;
require_is_graph();
//#endregion
//#region node_modules/@sigma/edge-curve/dist/sigma-edge-curve.esm.js
...
function createDrawCurvedEdgeLabel(_ref) {
	...
	return function(context, edgeData, sourceData, targetData, settings) {
		...
		for (var i = 0, length = label.length; i < length; i++) {
			...
			if (!charactersLengthCache[character]) charactersLengthCache[character] = context.measureText(character).width * (1 + curvature * .35);
		}
		var t = .5 - textLength / curveLength / 2;
...
function createEdgeCurveProgram(inputOptions) {
	...
	var UNIFORMS = [
		...
		"u_feather",
		"u_minEdgeThickness"
	].concat(_toConsumableArray(arrowHead ? ["u_lengthToThicknessRatio", "u_widenessToThicknessRatio"] : []));
	return /*#__PURE__*/ function(_EdgeProgram) {
...
var EdgeCurvedArrowProgram = createEdgeCurveProgram({ arrowHead: DEFAULT_EDGE_ARROW_HEAD_PROGRAM_OPTIONS });
var EdgeCurvedDoubleArrowProgram = createEdgeCurveProgram({ arrowHead: _objectSpread2(_objectSpread2({}, DEFAULT_EDGE_ARROW_HEAD_PROGRAM_OPTIONS), {}, { extremity: "both" }) });
//#endregion
