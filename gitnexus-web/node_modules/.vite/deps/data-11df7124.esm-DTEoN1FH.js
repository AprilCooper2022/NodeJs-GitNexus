...
//#region node_modules/sigma/dist/inherits-d1a1e29b.esm.js
...
//#endregion
//#region node_modules/sigma/dist/colors-beb06eb2.esm.js
...
function indexToColor(index) {
	...
	var color = rgbaToFloat((index & 16711680) >>> 16, (index & 65280) >>> 8, index & 255, 255, true);
...
//#endregion
//#region node_modules/sigma/dist/index-fad77a13.esm.js
		...
		},
		{
			...
			value: function bindAttribute(attr, program, offset, setDivisor) {
				...
				if (location !== -1) {
					...
					if (this.isInstanced && setDivisor) if (gl instanceof WebGL2RenderingContext) gl.vertexAttribDivisor(location, 1);
					else {
		...
		},
		{
			...
			value: function unbindAttribute(attr, program, unsetDivisor) {
				...
				if (location !== -1) {
					...
					if (this.isInstanced && unsetDivisor) if (gl instanceof WebGL2RenderingContext) gl.vertexAttribDivisor(location, 0);
					else {
						var ext = gl.getExtension("ANGLE_instanced_arrays");
		...
		},
		{
			...
			value: function render(params) {
				...
				if (this.pickProgram) {
					...
					this.renderProgram(_objectSpread2(_objectSpread2({}, params), {}, { pixelRatio: params.pixelRatio / params.downSizingRatio }), this.pickProgram);
...
function drawStraightEdgeLabel(context, edgeData, sourceData, targetData, settings) {
	...
	var angle;
	if (dx > 0) if (dy > 0) angle = Math.acos(dx / d);
...
var DEFAULT_EDGE_CLAMPED_PROGRAM_OPTIONS = { lengthToThicknessRatio: DEFAULT_EDGE_ARROW_HEAD_PROGRAM_OPTIONS.lengthToThicknessRatio };
...
var EdgeArrowProgram$1 = createEdgeArrowProgram();
...
//#endregion
//#region node_modules/sigma/dist/normalization-be445518.esm.js
var import_is_graph = /* @__PURE__ */ __toESM(require_is_graph());
var easings = {
...
function createNormalizationFunction(extent) {
	...
	fn.applyTo = function(data) {
		data.x = .5 + (data.x - dX) / ratio;
		data.y = .5 + (data.y - dY) / ratio;
	};
...
//#endregion
//#region node_modules/sigma/dist/data-11df7124.esm.js
function _typeof(o) {
...
//#endregion
export { _slicedToArray as A, _objectSpread2 as C, drawDiscNodeLabel as D, drawDiscNodeHover as E, _callSuper as F, _classCallCheck as I, _createClass as L, colorToIndex as M, floatColor as N, drawStraightEdgeLabel as O, getPixelColor as P, _inherits as R, _defineProperty as S, createEdgeCompoundProgram as T, EdgeArrowProgram$1 as _, createElement as a, FRAGMENT_SHADER_SOURCE as b, getMatrixImpact as c, identity as d, matrixFromCamera as f, DEFAULT_EDGE_ARROW_HEAD_PROGRAM_OPTIONS as g, zIndexOrdering as h, ANIMATE_DEFAULTS as i, _unsupportedIterableToArray as j, _arrayLikeToArray as k, getPixelRatio as l, validateGraph as m, assign as n, createNormalizationFunction as o, multiplyVec2 as p, extend as r, easings as s, _typeof as t, graphExtent as u, EdgeProgram as v, createEdgeArrowHeadProgram as w, NodeCircleProgram as x, EdgeRectangleProgram as y, _toPropertyKey as z };

//# sourceMappingURL=data-11df7124.esm-DTEoN1FH.js.map